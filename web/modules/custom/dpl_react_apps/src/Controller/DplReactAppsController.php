...
class DplReactAppsController extends ControllerBase {
  ...
  public function work(string $wid): array {
    ...
    $test4 = $this->t('Fourtfh translation 20:39', [], ['context' => 'Translation test']);
    $test5 = $this->t('Fifth translation 20:49', [], ['context' => 'Translation test']);
    $test6 = $this->t('Sixth translation 20:58', [], ['context' => 'Translation test']);
    $test7 = $this->t('Seventh translation 21:39', [], ['context' => 'Translation test']);
    $test8 = $this->t('Ninth translation 00:19', [], ['context' => 'Translation test']);
    $test9 = $this->t('Tenth translation 00:40', [], ['context' => 'Translation test']);
    $data = [
      'wid' => $wid,
      // Config.
      ...
      'details-list-audience-text'=> $this->t('Audience', [], $c),
      'details-list-contributors-text'=> $this->t('Contributors', [], $c),
      'details-list-edition-text'=> $this->t('Edition', [], $c),
      'details-list-first-edition-year-text'=> $this->t('Edition year', [], $c),
      'details-list-first-edition-year-unknown-text'=> $this->t('Unknown', [], $c),
      'details-list-genre-and-form-text'=> $this->t('Genre and form', [], $c),
      'details-list-isbn-text'=> $this->t('Isbn', [], $c),
      'details-list-language-text'=> $this->t('Language', [], $c),
      'details-list-original-title-text'=> $this->t('Original title', [], $c),
      'details-list-play-time-text'=> $this->t('Play time', [], $c),
      'details-list-publisher-text'=> $this->t('Publisher', [], $c),
      'details-list-scope-text'=> $this->t('Scope', [], $c),
      'details-list-type-text'=> $this->t('Type', [], $c),
